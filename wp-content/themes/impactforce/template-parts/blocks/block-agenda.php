<section id="<?php echo get_field('block_id'); ?>" class="agenda">
    <div class="container">
        ...
        <div class="content-wrap">
                ...
                <div class="table-column venue-column">
                    <div class="title venues">
                        <div class="display-flex">
                            <div class="content venue-1">Venue 1: Main Hall</div>
                            <div class="content venue-2">Venue 2: Innovation Hall </div>
                        </div>
                    </div>
                        ...
                        <div class="display-flex">
                            <div class="column venues-1">
                                <div class="venues-1-td">
                                    <span class="title"><strong>SIDE EVENT</strong></span>
                            ...
                            <div class="column venues-2">
                                <div class="venues-2-td">
                                    <span>Panel 4: <strong>“Mental Health Resilience in Wartime Ukraine"</strong></span>
                                </div>
                                <div class="venues-2-td">
                                   <span>Panel 5: <strong>“Reintegrating War-Affected Groups into the Workforce"</strong></span>
                                </div>
            ...
            <div class="calendar-table mobile">
                <!-- <span class="dots-wrap dots-g">
                    <svg xmlns="http://www.w3.org/2000/svg" width="43" height="7" viewBox="0 0 43 7" fill="none">
                        <circle cx="3.5" cy="3.5" r="3.5" fill="#003548"/>
                        <circle cx="15.5" cy="3.5" r="3.5" fill="#003548"/>
                ...
                <div class="table-column venue-column">
                    <div class="title venues">
                        <div class="display-flex">
                            <div class="content venue-1">Venue 1: </br>Main Hall</div>
                            <div class="content venue-2">Venue 2: Innovation Hall </div>
                        </div>
                    </div>
